...
\begin{document}
	...
	\begin{enumerate}
		...
		\begin{itemize}
			...
			Внешняя часть периода траектории равна при условии, что 
			\begin{eqnarray}
			...
			Если $r_{max} < 1$, то всё тривиально, однако если $r_{max} > 1$, траектория гибридная. Во внутренней части её период является разрывной фенкцией параметров $e, l$. 
	...
	Вообще мажно интерполировать ещё одну величину, равную
	\begin{equation}
